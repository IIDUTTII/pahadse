<script setup>
// cartview.vue ka STARTING part replace karo
import { ref, computed, onMounted }  from 'vue'
import { db, auth }                  from '../firebase.js'
import { onAuthStateChanged }        from 'firebase/auth'
import { doc, onSnapshot }           from 'firebase/firestore'
import { saveCartItems, fetchCoupons, fetchShippingConfig } from './db.js' // ✨ ADDED fetchShippingConfig
...
<template>
  ...
  <div class="progress-bar-container"><div class="progress-fill" :style="{ width: progressToFree + '%' }"></div></div>
          ...
          <div class="cart-items-wrapper">
            <div v-for="(item, idx) in cartItems" :key="item.productId" class="cart-item-card">
              ...
              <div class="item-core-details">
                <div class="item-title-row">
                  <div>
                    ...
                    <p class="item-weight">{{ item.weight || 'Pure Organic Allotment' }}</p>
                  </div>
...
.item-weight { margin: 0; font-size: 0.85rem; color: #6B7280; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; }
